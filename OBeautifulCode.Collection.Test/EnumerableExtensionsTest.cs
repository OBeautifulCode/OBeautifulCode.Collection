...
namespace OBeautifulCode.Collection.Test
{
    ...
    public static class EnumerableExtensionsTest
    {
        ...
        public static void IsDictionaryEqualTo___Should_return_true___When_both_dictionaries_are_null()
        {
            ...
            // Act
            var actual = EnumerableExtensions.IsDictionaryEqualTo(item1, item2);
        ...
        public static void IsDictionaryEqualTo___Should_return_true___When_one_but_not_both_dictionaries_are_null()
        {
            ...
            // Act
            var actual1 = EnumerableExtensions.IsDictionaryEqualTo(notNullDictionary, null);
            var actual2 = EnumerableExtensions.IsDictionaryEqualTo(null, notNullDictionary);
        ...
        public static void IsReadOnlyDictionaryEqualTo___Should_return_true___When_both_dictionaries_are_null()
        {
            ...
            // Act
            var actual = EnumerableExtensions.IsReadOnlyDictionaryEqualTo(item1, item2);
        ...
        public static void IsReadOnlyDictionaryEqualTo___Should_return_true___When_one_but_not_both_dictionaries_are_null()
        {
            ...
            // Act
            var actual1 = EnumerableExtensions.IsReadOnlyDictionaryEqualTo<string, string>(notNullDictionary, null);
            var actual2 = EnumerableExtensions.IsReadOnlyDictionaryEqualTo<string, string>(null, notNullDictionary);
        ...
        {
            // Arrange, Act
            var actual = EnumerableExtensions.IsSequenceEqualTo<object>(null, null);
        ...
        public static void IsSequenceEqualTo___Should_return_true___When_one_but_not_both_sequences_are_null()
        {
            ...
            // Act
            var actual1 = EnumerableExtensions.IsSequenceEqualTo<object>(notNullSequence, null);
            var actual2 = EnumerableExtensions.IsSequenceEqualTo<object>(null, notNullSequence);
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_true___When_both_sequences_are_null()
        {
            // Arrange, Act
            var actual = EnumerableExtensions.IsSymmetricDifferenceEqualTo<object>(null, null);
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_true___When_one_but_not_both_sequences_are_null()
        {
            // Arrange
            var notNullSequence = A.Dummy<List<string>>();

            // Act
            var actual1 = EnumerableExtensions.IsSymmetricDifferenceEqualTo(notNullSequence, null);
            var actual2 = EnumerableExtensions.IsSymmetricDifferenceEqualTo(null, notNullSequence);
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_true___When_both_sets_are_empty()
        {
            // Arrange
            ...
            // Act
            var actual = item1.IsSymmetricDifferenceEqualTo(item2, StringComparer.CurrentCulture);
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_true___When_sets_are_the_same()
        {
            // Arrange
            ...
            // Act
            var actual1 = item1a.IsSymmetricDifferenceEqualTo(item1b);
            var actual2 = item2a.IsSymmetricDifferenceEqualTo(item2b);
            var actual3 = item3a.IsSymmetricDifferenceEqualTo(item3b);
            var actual4 = item4a.IsSymmetricDifferenceEqualTo(item4b);
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_false___When_one_set_is_empty_and_the_other_is_not()
        {
            // Arrange
            var item1a = new List<string>();
            var item1b = new List<string> { "abc" };
            ...
            var actual3 = item3a.IsSymmetricDifferenceEqualTo(item3b);
            var actual4 = item4a.IsSymmetricDifferenceEqualTo(item4b);
            var actual5 = item5a.IsSymmetricDifferenceEqualTo(item5b);
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_false___When_sets_have_one_or_more_differences()
        {
            // Arrange
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_false___When_called_with_case_insensitive_comparer_and_sets_have_one_or_more_differences()
        {
            // Arrange
            var item1a = new List<string> { "def" };
            var item1b = new List<string> { "abc" };
            ...
            // Act
            var actual1 = item1a.IsSymmetricDifferenceEqualTo(item1b, StringComparer.CurrentCultureIgnoreCase);
            var actual2 = item2a.IsSymmetricDifferenceEqualTo(item2b, StringComparer.CurrentCultureIgnoreCase);
            var actual3 = item3a.IsSymmetricDifferenceEqualTo(item3b, StringComparer.CurrentCultureIgnoreCase);
            var actual4 = item4a.IsSymmetricDifferenceEqualTo(item4b, StringComparer.CurrentCultureIgnoreCase);
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_true___When_called_with_case_insensitive_comparer_and_sets_are_equal()
        {
            // Arrange
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_false___When_sets_contain_IEnumerables_and_sets_have_one_or_more_differences()
        {
            // Arrange
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_true___When_sets_contain_IEnumerables_and_sets_are_equal()
        {
            // Arrange
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_false___When_sets_contain_arrays_and_sets_have_one_or_more_differences()
        {
            // Arrange
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_true___When_sets_contain_arrays_and_sets_are_equal()
        {
            // Arrange
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_false___When_sets_contain_dictionaries_and_sets_have_one_or_more_differences()
        {
            // Arrange
            var item1a = new List<IReadOnlyDictionary<string, string>>
            {
        ...
        [Fact]
        public static void IsSymmetricDifferenceEqualTo___Should_return_true___When_sets_contain_dictionaries_and_sets_are_equal()
        {
            // Arrange
            var item1a = new List<IReadOnlyDictionary<string, string>>
            {
        ...
        {
            // Arrange, Act
            var actual = EnumerableExtensions.IsUnorderedEqualTo<object>(null, null);
        ...
        public static void IsUnorderedEqualTo___Should_return_true___When_one_but_not_both_sequences_are_null()
        {
            ...
            // Act
            var actual1 = EnumerableExtensions.IsUnorderedEqualTo(notNullSequence, null);
            var actual2 = EnumerableExtensions.IsUnorderedEqualTo(null, notNullSequence);
